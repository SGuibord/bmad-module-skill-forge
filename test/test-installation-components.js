...
async function runTests() {
  ...
  const stepFileChains = {
    ...
    'rename-skill': {
      steps: ['step-01-select.md', 'step-02-execute.md', 'step-03-report.md', 'step-04-health-check.md'],
    },
    'drop-skill': {
      steps: ['step-01-select.md', 'step-02-execute.md', 'step-03-report.md', 'step-04-health-check.md'],
    },
